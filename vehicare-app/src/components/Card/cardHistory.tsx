...
export default function CardHistory({ book }: { book: ServiceBooks }) {
    ...
    return (
        <>
            <button onClick={toggleModal} className="border group flex items-center gap-x-5 rounded-md px-2.5 py-2 transition-all duration-75 hover:bg-green-100 w-full mt-4">
